      ...
      <section className="relative w-full flex flex-col items-center">
        ...
        <div className="absolute top-0 left-0 w-full h-[600px] z-0 overflow-hidden">
          <img 
            ...
            alt="Céu" 
            className="w-full h-full object-cover opacity-60 dark:opacity-20 transition-opacity duration-500"
          />
        ...
        <nav className="relative z-10 w-full max-w-6xl px-6 py-6 flex justify-between items-center">
          ...
          <Link href="/" className="group flex items-center gap-3">
            <div className="w-10 h-10 bg-sky-600 rounded-xl flex items-center justify-center text-white shadow-lg shadow-sky-600/20 group-hover:rotate-6 transition-transform">
              <span className="font-serif font-bold text-2xl italic">L</span>
            </div>
            <span className="font-serif text-2xl font-bold text-sky-950 dark:text-sky-100 tracking-wide">
              Lumen
            </span>
          </Link>
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto mt-16 mb-24 px-6">
